...
//
//				//TODO last_uid = db.GetLastUID(account,folder)
//
//                Thread myThreadEvent = new Thread(new MailListenerThread(emailAccount, myFolder)); // �������� ������ ��� ������������ �������� � ������������ ������ // TODO 2 lsn
//                myFolder.setThreadLisaningChangeMessage(myThreadEvent);
//                myThreadEvent.start();
//
//                Thread myTreadAllMails = new Thread(new AddNewMessageThread(emailAccount, myFolder)); // �������� ������ ��� ������������� ����� ��������� ����� // TODO 1 all �������� last_uid
