...
public class AnnotatedChatClient {
    ...
    public void connected(Session session, EndpointConfig clientConfig){
        ...
        System.out.println("com.classes.User " + user + " connected to Chat room");
    }
    @OnMessage
    ...
    public void disconnected(Session session, CloseReason reason){
        System.out.println("com.classes.User "+ user + " disconnected as a result of "+ reason.getReasonPhrase());
    }
    @OnError
