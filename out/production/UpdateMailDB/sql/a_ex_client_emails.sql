...
--
-- Хост: localhost
-- Время создания: Июл 29 2018 г., 11:56
...
--
-- Структура таблицы `a_ex_client_emails`
--

CREATE TABLE IF NOT EXISTS `a_ex_client_emails` (
...
--
-- Индексы таблицы `a_ex_client_emails`
--
ALTER TABLE `a_ex_client_emails`
